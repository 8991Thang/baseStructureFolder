...
export const FormDetailCustomers = ({ name, nameCustomers, description, priority, status }) => {
  return (
    <div className="w-10/12 rounded-lg shadow-lg bg-white mt-10 ml-5">
      ...
      <div className="px-5 py-4 flex justify-end">
        ...
        <button className="border border-red-500 bg-red-500 text-white rounded-md px-3 py-2 m-2 transition duration-500 ease select-none hover:bg-red-600 focus:outline-none focus:shadow-outline">
          DELETE
        </button>
      </div>
    </div>
